...
if ps == "yes":
	...
	sectors_notirradiated, hv_notirradiated, spark_notirradiated, ID, timeslot, deltatime, efficiency, layers_efficiency, total_efficiency = MMPlotsDW.createsummaryplots()
